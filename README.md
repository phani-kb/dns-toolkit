...
|--------|-------|---------|
| **Total&nbsp;Sources** | 183 | 153 enabled, 30 disabled |
...
| **Last&nbsp;Updated** | 2026-01-23 23:28:33 UTC | Statistics generation time |
...
| fabriziosalmi_allowlist | ✅ | others | 2268 / 922 / 1026 | - |
...
| Name | S | Categories |         C / U / X        | Notes |
|------|---|------------|--------------------------|-------|
| 1Hosts (Lite) | ✅ | ads, trackers | 210766 / 0 / 124 | - |
...
| Dan Pollock's List | ✅ | ads, malware, trackers | 11874 / 0 / 23 | >95% overlap with StevenBlack Fake Gambling list |
...
| Frogeye-firstparty-trackers | ✅ | trackers | 32223 / 10816 / 12 | - |
| GetAdmiral Domains Filter List | ✅ | ads, annoyance | 1750 / 0 / 0 | - |
| GlobalAntiScamOrg-blocklist-domains | ✅ | scam | 11186 / 6507 / 2 | - |
...
| HaGeZi DNS TIF Mini | ✅ | malicious, threat | 117993 / 31360 / 2 | 100% covered by other sources |
...
| jarelllama_Scam-Blocklist | ✅ | scam | 468729 / 427408 / 10 | Disabled due to very large size (457K entries) - scam-specific focus |
...
| Maltrail_StaticTrails | ✅ | malware, threat | 216657 / 190902 / 70 | - |
| malware-filter_phishing-filter | ✅ | malware, phishing | 20579 / 0 / 0 | - |
...
| phishing_army | ✅ | phishing | 153057 / 0 / 1 | - |
...
| ShadowWhisperer_BlockLists Adult | ✅ | adult | 236112 / 178137 / 4 | Huge list and adult-specific focus |
| ShadowWhisperer_BlockLists Malware | ✅ | malware | 42344 / 0 / 4 | - |
| ShadowWhisperer_BlockLists Scam | ✅ | scam | 7208 / 4876 / 0 | - |
...
| StevenBlack_Fake_Gambling | ✅ | ads, fake, fakenews, gambling | 78443 / 0 / 151 | - |
...
| URLHaus (Abuse.ch) | ✅ | malware | 487 / 0 / 0 | - |
| USOM-Blocklists-domains | ✅ | malicious, threat | 435092 / 378633 / 18 | Huge list |
...
| BinaryDefense_Banlist | ✅ | malicious, threat | 2931 / 0 / 13 | This is for public use only. |
| Blackhole_Today | ❌ | malicious, threat | - | Download fails frequently due to network instability or potential blocking. |
| BlockListDE_Brute | ✅ | threat | 3568 / 0 / 5 | >95% overlap with Firehol_level2 |
| BlockListDE_Strong | ✅ | malicious, threat | 285 / 0 / 0 | >95% overlap with Borestad_AbuseIPDB_S100_3d |
| Borestad_AbuseIPDB_S100_3d | ✅ | malicious, threat | 72393 / 0 / 106 | - |
| BruteforceBlocker | ✅ | threat | 569 / 0 / 0 | >95% overlap with EmergingThreats_CompromisedIPs |
| CINSScore_BadGuys_Army | ✅ | malicious, threat | 15000 / 0 / 40 | - |
| DanMeUK_TorExitNodes | ✅ | tor | 1462 / 123 / 0 | - |
| DoH_IP_blocklists | ✅ | doh | 2527 / 734 / 2 | >90% overlap with HaGeZi Encrypted DNS Servers |
...
| ET_fwip | ✅ | malicious, threat | 1476 / 122 / 0 | - |
...
| Firehol_Botscout_1d | ✅ | malicious, threat | 497 / 379 / 0 | - |
| Firehol_CleanTalk | ✅ | malicious, threat | 494 / 457 / 0 | - |
| Firehol_CleanTalk_Top20 | ✅ | malicious, threat | 20 / 5 / 0 | - |
| Firehol_GPF_Comics | ✅ | malicious, threat | 2644 / 1924 / 12 | - |
| Firehol_level1 | ✅ | malicious, threat | 4481 / 3127 / 0 | - |
| Firehol_level2 | ✅ | malicious, threat | 17549 / 0 / 2254 | - |
| Firehol_level3 | ✅ | malicious, threat | 12358 / 0 / 68 | - |
| Firehol_SocksProxy_7d | ✅ | anonymizer, privacy, proxy | 68 / 0 / 0 | - |
| Firehol_SSLProxies_1d | ✅ | anonymizer, privacy, proxy | 317 / 173 / 0 | - |
| GlobalAntiScamOrg-blocklist-ips | ✅ | scam | - | - |
| Greensnow | ✅ | malicious, malware, threat | 6350 / 0 / 18 | >95% overlap with Firehol_level2 |
| HaGeZi_DoH | ✅ | doh | 1633 / 0 / 1 | >90% overlap with DoH_IP_blocklists |
| HaGeZi_TIF | ✅ | malicious, threat | 44788 / 0 / 67 | No unique contribution |
| MyIP_MS_Blocklist | ✅ | malicious, threat | - | - |
| Public_DNS4 | ✅ | dns | 62607 / 61698 / 0 | - |
| Rutgers_DROP | ✅ | malicious, threat | 1883 / 0 / 103 | - |
| Sblam_Blocklist | ✅ | spam | 1274 / 527 / 0 | - |
| ScriptzTeam_BadIPS | ✅ | malicious, threat | 2567 / 1361 / 0 | - |
| Sefinek_Known_Bots_IP | ✅ | bot | 13609 / 0 / 13609 | - |
| Sentinel_Greylist | ✅ | malicious, threat | 10006 / 0 / 130 | - |
...
| ThreatView_IP_HighConfidence | ✅ | malicious, phishing, threat | 6181 / 0 / 8 | - |
| URLHaus_Text | ✅ | malware | 20576 / 0 / 0 | - |
| USOM-Blocklists-ips | ✅ | malicious, threat | 13696 / 7790 / 3 | - |
