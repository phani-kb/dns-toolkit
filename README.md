...
| **Last&nbsp;Updated** | 2026-01-23 11:35:23 UTC | Statistics generation time |
...
| AdGuardTeam_HttpsExclusions_banks | ✅ | finance | 3979 / 3938 / 25 | - |
...
| fabriziosalmi_allowlist | ✅ | others | 2268 / 922 / 1027 | - |
...
| Name | S | Categories |         C / U / X        | Notes |
|------|---|------------|--------------------------|-------|
| 1Hosts (Lite) | ✅ | ads, trackers | 210766 / 0 / 125 | - |
...
| AdGuard DNS filter | ✅ | ads, mobile, social, trackers | 138188 / 0 / 75 | - |
...
| bigdargon_hostsVN | ✅ | ads | 17334 / 0 / 86 | - |
...
| Blocklists UT1 Publicite | ✅ | ads | 4270 / 0 / 89 | 100% covered by other sources |
...
| cyberhost_malware-blocklist | ✅ | malware | 19947 / 0 / 2 | - |
| Dan Pollock's List | ✅ | ads, malware, trackers | 11868 / 0 / 23 | >95% overlap with StevenBlack Fake Gambling list |
| DandelionSprout-Anti-Malware-List | ✅ | malware | 16729 / 16721 / 0 | - |
| Easy Privacy | ✅ | privacy, trackers | 54068 / 22371 / 1 | - |
| EasyList | ✅ | ads | 68596 / 0 / 0 | 100% covered by other sources |
...
| GlobalAntiScamOrg-blocklist-domains | ✅ | scam | 11186 / 6504 / 2 | - |
...
| HaGeZi DNS TIF Mini | ✅ | malicious, threat | 114052 / 17821 / 2 | 100% covered by other sources |
...
| HaGeZi Pro | ✅ | ads, malware, phishing, trackers | 340045 / 0 / 124 | - |
...
| jarelllama_Scam-Blocklist | ✅ | scam | 468729 / 425156 / 10 | Disabled due to very large size (457K entries) - scam-specific focus |
...
| Maltrail_StaticTrails | ✅ | malware, threat | 216657 / 190184 / 5 | - |
| malware-filter_phishing-filter | ✅ | malware, phishing | 20476 / 0 / 0 | - |
| OISD Blocklist Big | ✅ | ads, cryptocurrency, malware, phishing, ransomware, trackers | 210916 / 0 / 35 | Huge list |
| OISD Blocklist NSFW Small | ✅ | adult | 16194 / 0 / 5 | - |
| OISD Blocklist Small | ✅ | ads, cryptocurrency, malware, phishing, ransomware, trackers | 49537 / 0 / 28 | - |
...
| ph00lt0_blocklist | ✅ | ads, trackers | 22506 / 0 / 360 | 100% covered by other sources, ~50 ip addresses in domain list |
| phishing_army | ✅ | phishing | 152656 / 0 / 1 | - |
...
| ShadowWhisperer_BlockLists Ads | ✅ | ads | 25736 / 0 / 43 | - |
| ShadowWhisperer_BlockLists Adult | ✅ | adult | 236112 / 178059 / 4 | Huge list and adult-specific focus |
...
| StevenBlack_Fake_Gambling | ✅ | ads, fake, fakenews, gambling | 78443 / 0 / 152 | - |
...
| ThreatFox_Hostfile | ✅ | malware, threat | 45198 / 0 / 0 | - |
...
| Warui_Adhosts | ✅ | ads | 75777 / 0 / 184 | Huge list |
...
| Yoyo Adservers-Hosts | ✅ | ads | 3499 / 0 / 54 | >95% overlap with StevenBlack Fake Gambling list |
...
| Name | S | Categories |         C / U / X        | Notes |
|------|---|------------|--------------------------|-------|
| tranco | ✅ | topdomains | 500 / 0 / 627 | Reduced to 500, as many conflicts with other sources |
...
| BlockListDE_Brute | ✅ | threat | 3825 / 0 / 0 | >95% overlap with Firehol_level2 |
| BlockListDE_Strong | ✅ | malicious, threat | 287 / 0 / 0 | >95% overlap with Borestad_AbuseIPDB_S100_3d |
| Borestad_AbuseIPDB_S100_3d | ✅ | malicious, threat | 74873 / 0 / 0 | - |
| BruteforceBlocker | ✅ | threat | 567 / 0 / 0 | >95% overlap with EmergingThreats_CompromisedIPs |
| CINSScore_BadGuys_Army | ✅ | malicious, threat | 15000 / 0 / 0 | - |
| DanMeUK_TorExitNodes | ✅ | tor | 1472 / 170 / 0 | - |
| DoH_IP_blocklists | ✅ | doh | 2534 / 739 / 1 | >90% overlap with HaGeZi Encrypted DNS Servers |
...
| Firehol_GPF_Comics | ✅ | malicious, threat | 2644 / 1960 / 0 | - |
...
| Greensnow | ✅ | malicious, malware, threat | 5603 / 0 / 0 | >95% overlap with Firehol_level2 |
...
| Rutgers_DROP | ✅ | malicious, threat | 1642 / 0 / 0 | - |
| Sblam_Blocklist | ✅ | spam | 1274 / 544 / 0 | - |
| ScriptzTeam_BadIPS | ✅ | malicious, threat | 2567 / 1373 / 0 | - |
...
| URLHaus_Text | ✅ | malware | 20585 / 0 / 0 | - |
| USOM-Blocklists-ips | ✅ | malicious, threat | 13696 / 7778 / 0 | - |
