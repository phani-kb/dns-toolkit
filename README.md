...
- **Output branch size:** 286.81 MB
- **Summaries branch size:** 0.95 MB
...
|--------|-------|---------|
| **Total Sources** | 156 | 107 enabled, 49 disabled |
...
| **Last Updated** | 2025-08-11 13:29:10 UTC | Statistics generation time |
