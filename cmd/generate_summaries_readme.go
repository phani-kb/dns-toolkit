...
func generateSummariesReadme() string {
	...
	sb.WriteString("This directory contains JSON summary files generated by the DNS Toolkit workflow.\n")
	sb.WriteString(
		"These files provide detailed information about the processing pipeline and can be used for analysis and monitoring.\n\n",
	)
	...
	sb.WriteString(
		"These summaries are automatically generated by the [DNS Toolkit](https://github.com/phani-kb/dns-toolkit) ",
	)
...
func getDetailedStatsForSummaryType(filename string) string {
	...
	case "top_summary.json":
		...
		for _, summary := range topSummaries {
			totalEntries += summary.Count
			minStr := fmt.Sprintf("%d+ min (%d)", summary.MinSources, summary.Count)
